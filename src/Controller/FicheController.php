...
class FicheController extends AbstractController
{
    ...
    {
        return $this->render('back_office/fiche/index.html.twig', [
    ...
    public function new(Request $request, FicheRepository $ficheRepository): Response
    {
        ...
        return $this->renderForm('back_office/fiche/new.html.twig', [
            'fiche' => $fiche,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('back_office/fiche/show.html.twig', [
            'fiche' => $fiche,
        ]);
    }
    ...
    public function edit(Request $request, Fiche $fiche, FicheRepository $ficheRepository): Response
    {
        ...
        return $this->renderForm('back_office/fiche/edit.html.twig', [
            'fiche' => $fiche,
            'form' => $form,
        ]);
    }
